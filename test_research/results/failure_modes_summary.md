...
**LLM (gate evaluation tests):** mistral-small-2412 via api.mistral.ai (temperature=0, pinned for reproducibility)  
...
5. Returns `{"approved": False, "score": 0, "model": "mistral-small-2412", ...}`
...
*Model: mistral-small-2412 (temperature=0) | All git test commits reverted after each test*
