...
def _warden_llm_analyze(warden_llm: str, drift_value: float, justification: str) -> dict:
    ...
    if warden_llm == "gemini":
        ...
        payload = {"model": "mistral-small-2506", "messages": [{"role": "user", "content": prompt}], "max_tokens": 512, "temperature": 0}
        raw_text = ""
        ...
        try:
            ...
            return {
                "approved": decision == "APPROVED",
                "reasoning_trace": _build_trace("mistral-small-2506", score, decision, reasoning),
            ...
            return {
                "approved": False,
                "reasoning_trace": _build_trace("mistral-small-2506", 0, "REJECTED", fallback_msg),
                "model": "mistral-small-2506",
                "hash": run_hash,
                "score": 0,
            }
