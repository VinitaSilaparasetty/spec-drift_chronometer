...
* **Regional Compliance:** `eu-central-1` (Frankfurt) ONLY.
...
* **Dependency Policy:** Zero tolerance for non-Python runtimes in the core logic path.
...
* **Precondition:** IF the change violates the Architectural Baseline defined in `.kiro/`.
...
**REQ-TECH-004: Immutable Audit Trail**
