...
- **REQ-AUD-001**: Intent Ledger Logging
    ...
    - **Acceptance Criteria**:
        1. Logs MUST capture the "Negotiation" between Coder and Warden agents.
        2. Logs MUST follow the Structured-JSON-Logging pattern (Article 12 compliance).
        3. Implementation SHALL be asynchronous to avoid IDE lag, provided the "Gate" logic remains blocking.
